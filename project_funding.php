...
<head>
  <title>Project Funding - MindFin</title>
  <meta name="description" content="Mindfin, Project loan is the long-term financing of infrastructure and industrial projects based upon the projected cash flows of the project rather than the balance sheets of its sponsors. Basically, a project financing structure associates a number of equity investors, known as 'sponsors', a 'syndicate' of banks or other lending institutions that provide loans to the operation. They are most frequently non-recourse loans, which are secured by the project assets and paid thoroughly from project cash flow, rather than from the general assets or creditworthiness of the project sponsors, a decision in part promoted by financial modeling.">
...
<body>
    ...
    <section class="secondary-banner project-funding-banner">
    ...
    <section class="portfolio-detail-sec">
        <div class="container">
            <div class="row">
                <div class="col-sm-9">
                    <div class="personal-heading">
                        <h2>We are engaged in offering Project Finance Services</h2>
                    </div>
                </div>
                <div class="col-sm-3">
            ...
            <!-- <div class="row">
                <div class="col-sm-12">
                    <img class="img-responsive mar-b-20" src="./images/project details.jpg" >
                </div>
            </div> -->
            <!--  <div class="row">
                <div class="col-sm-7">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h3>Project Finance Services Leveraging on our vast industrial know how, we have become a reliable service provider of our domain. We are engaged in offering Project Finance Services</h3>
                    <p>Project loan is the long-term financing of infrastructure and industrial projects based upon the projected cash flows of the project rather than the balance sheets of its sponsors. Basically, a project financing structure associates a number of equity investors, known as 'sponsors', a 'syndicate' of banks or other lending institutions that provide loans to the operation. They are most frequently non-recourse loans, which are secured by the project assets and paid thoroughly from project cash flow, rather than from the general assets or creditworthiness of the project sponsors, a decision in part promoted by financial modeling.</p>
                </div>
            </div>
            ...
            <div class="tags-wrapper">
                <div class="row">
                    <div class="col-sm-3">
                        <h6 class="sub-head-primary" style="font-size: 20px;"><strong>We deal in the following projects:</strong></h6>
                        <p></p>
                    </div>
                    <div class="col-sm-9">
                        <p>• Start-UpProjects
                            <br>• WindPowerProject
                            <br>• HospitalProject
                            <br>• DairyFirmDevelopment
                            <br>• CollegeProject
                            <br>• SchoolDevelopmentProject
                            <br>• RiceMealProject 
                            <br>• Real-estateprojects
                            <br>• NPA(Non Performing Assets)
                        </p>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="personal-heading">
                    <h6 class="sub-head-primary" style="font-size: 20px;"><strong>Documents Required for Business Loan</strong></h6>
                        <h6 class="sub-head-secondary">Proof of individual’s identity (We also require same KYC of co-applicant)</h6>
                    </div>
                </div>
            </div>
            ...
            <ul class="doc_req_for_bl">
                ...
                <li>
                    <div class="step-content">Business Profile</div>
                </li>
                <li>
                    <div class="step-content">Complete Project Report from CA.</div>
                </li>
                <li>
                    <div class="step-content"> Estimated Project Cost Sheet</div>
                </li>
                <li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="personal-heading">
                        <h3 class="sub-head-secondary">If there is any 3rd person appointed by our borrower for dealing his project, we also want 3rd person complete KYC.*</h3>
                    </div>
                </div>
            </div>
            <!--<div class="row">-->
