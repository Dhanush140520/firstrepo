...
<head>
  <title>Construction-Equipment-Finance-Loan - MindFin</title>
  <meta name="description" content="Mindfin, Equipment finance is a common tool used by lots and lots of companies as part of a business recovery program, as it can help to improve cash flow and also improve working capital">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ul>
                        ...
                        <li><a href="#">Construction Equipment Finance</a></li>
                    </ul>
                </div>
            </div>
        </div>
