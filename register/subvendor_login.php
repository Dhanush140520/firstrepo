	        ...
	        <div class="row">
		        <div class="col-sm-8 col-sm-offset-2">
		            ...
		            <div class="wizard-container">
		                ...
		                <form action="actions/form_action.php?f=sub_vendor_login" method="post">
		                <!--        You can switch " data-color="green" "  with one of the next bright colors: "blue", "azure", "orange", "red"       -->

		                    	<div class="wizard-header">
		                        	<h3 class="wizard-title">Sub Vendor Login</h3>
		                    	</div>
		                        ...
		                        <div class="tab-content" style="padding: 51px 20px 10px; min-height:0px;">
		         ...
		         <!--                           	<h5 class="info-text"> Personal Information</h5>-->
											...
											<div class="col-sm-10 col-sm-offset-1">
			                                	<div class="form-group">
			                                       <label class="control-label">Username</label><br>
										            <input type="email" name="username" class="form-control"  placeholder="Username/Email *" required="required">
			                                    </div>
			                                </div>
			                                <div class="col-sm-10 col-sm-offset-1">
			                                	<div class="form-group">
			                                ...
			                                <!--      <input type="text" name="email" class="form-control"  placeholder="Company Email *" required="required">-->
			                                <!--    </div>-->
			                                <!--</div>-->
			                                <!--<div class="col-sm-5">-->
			                                <!--     <div class="form-group">-->
			                                <!--        <label>Personal Email*</label>-->
			                                <!--        <input type="email" name="email" class="form-control"  placeholder="Personal Email *" required="required">-->
			                                <!--    </div>-->
			                                <!--</div>-->
			                   <!--             <div class="col-sm-5 col-sm-offset-1">-->
			                   <!--                  <div class="form-group">-->
                      ...
                      <!--                              <input type="text" name="altmobile" class=" form-control" maxlength = "10" placeholder="Alternative Contact Number..." oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />-->
			                   ...
			                   <!--             </div>-->
		                            	...
		                            	<div class="text-center">
		                            	    <input type="submit" class="btn btn-success btn-wd" name="submit" value="submit">
		                            	</div>
