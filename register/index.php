...
<body>
	<div class="image-container set-full-height" style="background-image: url(&quot;assets/img/paper-5.jpg&quot;); height: auto;">
	    <div class="logo-container">
				...
				<a href="../index.php"><img src="../images/mindfin-logo.png" style="max-height:60px;"></a>
	            </div>
	        ...
	        <div class="row">
		        <div class="col-sm-8 col-sm-offset-2">
		            ...
		            <div class="wizard-container">
		                ...
		                <form action="actions/form_action.php?f=add_customer" method="post" enctype="multipart/form-data" novalidate="novalidate">
		                <!--        You can switch " data-color="green" "  with one of the next bright colors: "blue", "azure", "orange", "red"       -->
								...
								<div class="wizard-navigation">
									...
									<ul class="nav nav-pills">
										<li class="active" style="width: 25%;">
											<a href="#info_hotel" data-toggle="tab" aria-expanded="true">
										...
										<!-- <li style="width: 25%;">
											<a href="#info_cus2" data-toggle="tab"></a>
										</li> -->
		                        ...
		                        <div class="tab-content" style="padding: 51px 20px 10px;">
			                                     ...
			                                     <div class="form-group">
                                                    ...
                                                    <select name="loanpurpose" class="loan_purpose form-control" required="required" aria-required="true">
														...
														<option value="Bussiness Loan">Bussiness Loan</option>
                                                                                                                ...
                                                                                                                <option value="Mortage / LAP">Mortage / LAP</option>
                                                                                                                <option value="Working Capital Loan Services">Working Capital Loan Services</option>
											  ...
											  <tr>  
												   <td> 
    												   ...
    												   <option disabled="" selected="">-- Loan Type -- </option>
                                                                                                                        ...
                                                                                                                        <option value="3">Mortage /LAP</option>
												   ...
												   <td>
    												   ...
    												   <option disabled="" selected="">-- Bank Name --</option>
                                                                                                                        ...
                                                                                                                        <option value="4">BORADA</option>
                                                                                                                        <option value="5">MYSORE</option>
                                                                                                                        <option value="6">Vijaya BANK</option>
		                            ...
		                            <!-- <div class="tab-pane" id="info_cus2">
		                            	<div class="row">
		                                	<div class="col-sm-12">
		                                    	<h5 class="info-text"> File Upload</h5>
											</div>
											<div class="col-sm-10 col-sm-offset-1">
			                                	<div class="form-group">
